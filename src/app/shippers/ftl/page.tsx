...
const includedItems = [
  {
    ...
    description: 'Trafiicology Logistics is equipped to handle all your full truckload requirements and can also serve as your single-source provider of North American OTR solutions.',
  },
  {
    title: 'Flexibility',
    description: 'When demand shifts unexpectedly or last-minute changes to your supply chain are needed, Trafiicology Logistics is ready to adapt alongside your business.',
  },
  {
  ...
  },
  {
    ...
    description: 'At Trafiicology Logistics, we specialize in solving complex problems. Our Net Promoter Score (NPS) feedback indicates this is what our customers appreciate most about working with our team.',
  },
  {
...
const benefits = [
  {
    ...
    description: "Trafiicology Logistics' team of experts are committed to the business success of our clients. We apply our years of experience to solving complex challenges and delivering results."
  },
  {
    icon: (props: SVGProps<SVGSVGElement>) => (
      <svg {...props} xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
...
const faqItems = [
  {
    ...
    answer: "Trafiicology Logistics provides over-the-road transportation services across Canada, the USA, and Mexico. Contact Us today to start building your over-the-road solutions!",
  },
  {
    question: "Do you own your own assets?",
    answer: "Trafiicology Logistics has a small fleet of trucks and trailers located in Canada. Our fleet operates domestically within Canada and cross-border between the USA and Canada.",
  },
  {
    question: "Do you ship hazardous freight?",
    answer: "Yes, Trafiicology Logistics has a network of haz-certified premium carriers. Trafiicology Logistics does NOT transport Class 1 (Explosives), Class 2.1 (Flammable Gasses), Class 2.3 (Toxic Gasses), Class 5.1 (Oxidizing Substances), Class 6.1 (Toxic Substances), Class 7 (Radioactive Materials), or Packing Group I.",
  },
  {
    question: "How many trucks do you have in your network?",
    answer: "In today’s transportation market, where fraud and theft are significant concerns, Trafiicology Logistics prioritizes having the right capacity over the most capacity. With over 45 years of experience, we’ve developed a meticulous vetting process overseen by our expert risk management team. This ensures that we provide our clients with extensive capacity across North America, partnering only with premium carriers who have proven track records. Contact us today to discover how we can secure the right capacity for your transportation needs.",
  },
  {
    question: "Is Trafiicology Logistics CTPAT certified?",
    answer: "Trafiicology Logistics goes beyond just having a CTPAT (Customs Trade Partnership Against Terrorism) certification; we also hold FAST (Free and Secure Trade), and PIP (Partners in Protection) certifications, and are fully bonded and insured. This comprehensive accreditation makes us the perfect choice as your cross-border partner. Contact us today to learn more!",
  },
];
