      ...
      <div className="relative h-screen bg-black text-white flex items-center">
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="Truck crossing the US-Mexico border"
            data-ai-hint="desert highway"
            fill
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col items-center text-center">
            <Reveal>
            <Globe className="w-20 h-20 text-primary mb-6" />
            </Reveal>
            <Reveal delay={0.1}>
            ...
            <p className="mt-6 text-xl max-w-lg text-gray-300">
                Reliable and efficient shipping solutions for Mexico.
            </p>
            </Reveal>
            <Reveal delay={0.3}>
