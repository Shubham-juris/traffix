...
const benefits = [
    {
        ...
        description: "Trafficology Logistics' team of experts are committed to your business success. They apply their years of experience to solving complex challenges and delivering results with customized flatbed solutions."
    },
    {
        icon: (props: SVGProps<SVGSVGElement>) => (
            <svg {...props} xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
        ...
        description: 'While some brokers prioritize maximum capacity, Trafficology Logistics prioritizes the right capacity. Experience peace of mind knowing your flatbed freight is handled by our meticulously vetted premium carriers.'
    },
    {
        icon: (props: SVGProps<SVGSVGElement>) => (
            <svg {...props} xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
    ...
    },
    {
        ...
        title: 'Visibility',
        description: 'As flatbed delivery often involves job sites or meeting offload crews, we understand how important visibility in transit is. Trafficology Logistics provides both technology enabled flatbed shipment tracking and customized updates.'
    },
    {
        icon: (props: SVGProps<SVGSVGElement>) => (
            <svg {...props} xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="mt-6 text-lg text-gray-300 max-w-md">
                Each member of Trafficology Logistics' flatbed team boasts a minimum of 10 years of experience, equipping them with the depth of knowledge and expertise required to optimize your flatbed shipments.
              </p>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="mt-6 text-lg text-gray-300 max-w-md">
              Project freight is one of the most intricate types of transportation, and our team's extensive experience and dedication to delivering high-performance results makes Trafficology Logistics your premier choice for project freight solutions.
            </p>
