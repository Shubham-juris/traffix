...
const benefits = [
    ...
    },
    {
        ...
        description: 'Whether selecting the ideal Class 1 railroad for your supply chain or choosing the best drayage carrier, Trafiicology Logistics ensures you have the right capacity to meet your needs.'
    },
    {
        icon: (props: SVGProps<SVGSVGElement>) => (
            <svg {...props} xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
        ...
        title: 'Expertise',
        description: 'Trust Trafiicology Logistics\' intermodal team, each with 5+ years of experience, to guide your intermodal shipping needs and deliver high-performance results.'
    },
    {
        icon: (props: SVGProps<SVGSVGElement>) => (
            <svg {...props} xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
...
const includedItems = [
    {
        ...
        description: "Unlike many other intermodal marketing companies (IMCs), Trafiicology Logistics' intermodal service is delivered by dedicated account managers, ensuring you feel valued and supported regardless of your volume.",
    },
    {
        title: 'Comprehensive Service Offering',
        description: 'Trafiicology Logistics offers a true IMC operating model with full control of drayage and railroad movements to ensure superior service and cost control.',
    },
    {
    ...
    },
    {
        ...
        description: 'Trafiicology Logistics maintains direct relationships with all Class 1 railroads, enabling us to collaborate closely with them to establish tailored requirements on your behalf.',
    },
    {
...
const faqItems = [
    ...
    {
        question: "What type of intermodal service does Trafiicology Logistics offer?",
        answer: "Trafiicology Logistics’ intermodal team will build customized, full-service solutions based on your needs. Whether you are shipping from port-to-port, door-to-door, or anything in between, Trafiicology Logistics’ comprehensive service offering has you covered from pickup to delivery. Contact us today to learn more.",
    },
    {
        question: "Where does the Trafiicology Logistics intermodal network extend?",
        answer: "Trafiicology Logistics works with all Class 1 railroads across Canada, the USA, and Mexico. Contact our team today to learn more!",
    },
];
