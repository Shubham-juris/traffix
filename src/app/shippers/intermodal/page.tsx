...
const benefits = [
    ...
    },
    {
        ...
        description: 'Whether selecting the ideal Class 1 railroad for your supply chain or choosing the best drayage carrier, TRAFFIX ensures you have the right capacity to meet your needs.'
    },
    {
        icon: (props: SVGProps<SVGSVGElement>) => (
            <svg {...props} xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
        ...
        title: 'Expertise',
        description: 'Trust TRAFFIX\' intermodal team, each with 5+ years of experience, to guide your intermodal shipping needs and deliver high-performance results.'
    },
    {
        icon: (props: SVGProps<SVGSVGElement>) => (
            <svg {...props} xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
