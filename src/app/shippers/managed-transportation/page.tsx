...
const includedItems = [
    ...
    },
    {
        ...
        description: 'Trafiicology Logistics customizes solutions tailored to optimize order management, load planning, transportation costs, efficiency, and transit times.',
    },
    {
    ...
    },
    {
        ...
        description: 'Trafiicology Logistics engineers and implements customized systems and processes designed to help your business scale, while our expert team maintains a strong focus on individualized and detailed aspects.',
    },
    {
        title: 'The Right Resources',
        description: 'Trafiicology Logistics aims to reduce financial and operational costs by leveraging the three pillars of MTS: technology, our team of experts, and the right capacity.',
    },
];
...
const benefits = [
    {
        ...
        description: "Trafiicology Logistics MTS is an extension of your business, bringing over 45+ years of North American transportation expertise to optimize your supply chain operations."
    },
    {
        icon: (props: SVGProps<SVGSVGElement>) => (
            <svg {...props} xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
        ...
        description: 'While some outsourced logistics providers prioritize maximum capacity, Trafiicology Logistics curates the right capacity solutions with our meticulously vetted premium carrier network.'
    },
    {
        icon: (props: SVGProps<SVGSVGElement>) => (
            <svg {...props} xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
...
const faqItems = [
    ...
    },
    {
        ...
        answer: "Trafiicology Logistics MTS encompasses transportation planning and optimization, carrier procurement and management, shipment execution and tracking, performance analytics and reporting, and freight auditing and payment. For more information on our comprehensive services, contact us today!",
    },
    {
        ...
        answer: (
            <div>
                ...
                <ul className="list-disc pl-5 space-y-1 text-gray-700">
                    <li>This is a centralized solution that includes technology, an expertly trained dedicated team, and Trafiicology Logistics’ premium capacity.</li>
                    <li>Trafiicology Logistics industry-leading transportation management system (TMS) will be used for all in-scope modes.</li>
                    <li>Trafiicology Logistics will execute and manage all in-scope modes of transportation for you through contracted capacity with carriers from our premium network.</li>
                </ul>
                <h4 className="font-bold mt-4 mb-2">Managed TMS (4PL)</h4>
                <ul className="list-disc pl-5 space-y-1 text-gray-700">
                    <li>This is a centralized solution that includes technology, an expertly trained dedicated team, and a combination of your capacity and Trafiicology Logistics’ premium capacity.</li>
                    <li>This is an end-to-end supply chain management solution.</li>
                    <li>Trafiicology Logistics will manage all in-scope moves on your behalf through contracted carriers.</li>
                </ul>
                <h4 className="font-bold mt-4 mb-2">SaaS Solution</h4>
                <ul className="list-disc pl-5 space-y-1 text-gray-700">
                    <li>This is a technology only solution that gives you access to Trafiicology Logistics’ cloud-based TMS where you can manage all in-scope modes.</li>
                    <li>Your team is in the driver’s seat, executing and managing shipments within the TMS.</li>
                    <li>Network capacity is contracted and managed by your team; however, you may also access carriers from Trafiicology Logistics’ premium network.</li>
                </ul>
    ...
    },
    {
        ...
        answer: "Yes, on average, Trafiicology Logistics has saved its managed transportation clients 18% – 25% overall in the first year of partnership. Book your no-obligation consultation today to learn more about how Trafiicology Logistics’ managed transportation solutions can generate savings for your business!",
    },
    {
