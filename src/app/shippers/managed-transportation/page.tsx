...
const benefits = [
    {
        ...
        description: "TRAFFIX MTS is an extension of your business, bringing over 45+ years of North American transportation expertise to optimize your supply chain operations."
    },
    {
        icon: (props: SVGProps<SVGSVGElement>) => (
            <svg {...props} xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
        ...
        description: 'While some outsourced logistics providers prioritize maximum capacity, TRAFFIX curates the right capacity solutions with our meticulously vetted premium carrier network.'
    },
    {
        icon: (props: SVGProps<SVGSVGElement>) => (
            <svg {...props} xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
